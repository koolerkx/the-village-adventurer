...
#pragma region SLIME_ANIMATION_DATA
      {
        MobActionState::IDLE_DOWN, {
          .frames = scene_object::MakeFramesVector(1, 32, 32, 1, 0, 64),
      ...
      },
      {
        MobActionState::HURT_DOWN, {
          .frames = scene_object::MakeFramesVector(4, 32, 32, 4, 0, 64),
          .frame_durations = scene_object::MakeFramesConstantDuration(0.05f, 4),
        }
      },
      {
...
#pragma endregion
    ...
    MobState MakeMob(TileMapObjectProps props) {
      constexpr int DEFAULT_HP = std::numeric_limits<int>::max();
      ...
      constexpr float COLLIDER_PADDING = 3.0f;
    ...
    void HandleMovement(MobState&, Vector2) {}

    void SyncCollider(MobState&) {}
    ...
    void UpdateMob(MobState& mob_state, float delta_time, Vector2) {
